...
@section('title', 'Show Berita Premium')
            ...
            <div class="card" style="background-color:rgb(255,255,255);">                  
                <div class="card-body">
                    ...
                    <div class="row g-0 mb-3">
                        <div class="col-4">
                            <img src="https://lumiere-a.akamaihd.net/v1/images/sa_pixar_virtualbg_coco_16x9_9ccd7110.jpeg" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-8">
                            <div class="align-items-start ms-2">
                                <h4 class="mb-1" style="font-size:14px;">Berita Terkini Januari 2022</h4>
                                <p class="mb-1" style="font-size:12px;"><span class="badge bg-danger">Premium</span> <span class="badge bg-primary">Tips & Trick</span></p>                                                        
                            </div>
                        </div>
                    </div>
                    <div class="row g-0 mb-3">
